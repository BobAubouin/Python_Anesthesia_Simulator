...
:rotating_light: **This repository is no more maintained, please refer to the version hosted [here](https://github.com/AnesthesiaSimulation/Python_Anesthesia_Simulator)** :rotating_light:
