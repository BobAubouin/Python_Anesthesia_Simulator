...
Remifentanil clinical trials are rarer and usually, only one compartment is used to model the distribution of this drug in blood. In PAS the model from @beloeilNorepinephrineKineticsDynamics2005 is programmed.
